...
import (
	...
	"github.com/feifeigood/checkup/prometheus/serializer"
...
func NewCollector(expire time.Duration) *Collector {
	return &Collector{
		expireDuration: expire,
		coll:           serializer.NewCollection(),
	}
}
...
func (c *Collector) Add(metrics []checkup_metric.Metric) error {
	c.Lock()
	defer c.Unlock()
