...
func MetricName(measurement, fieldKey string, valueType checkup_metric.ValueType) string {
	switch valueType {
	case checkup_metric.Histogram, checkup_metric.Summary:
		switch {
...
func MetricType(valueType checkup_metric.ValueType) *dto.MetricType {
	switch valueType {
	case checkup_metric.Counter:
		return dto.MetricType_COUNTER.Enum()
	case checkup_metric.Gauge:
		return dto.MetricType_GAUGE.Enum()
	case checkup_metric.Summary:
		return dto.MetricType_SUMMARY.Enum()
	case checkup_metric.Untyped:
		return dto.MetricType_UNTYPED.Enum()
	case checkup_metric.Histogram:
		return dto.MetricType_HISTOGRAM.Enum()
	default:
		panic("unknown checkup_metric.ValueType")
	}
}
