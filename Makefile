...
BINARY_NAME=checkup
MAIN_PATH=cmd/checkup/main.go
VERSION=$$(cat VERSION)
GIT_SHA=$$(git rev-parse --short HEAD || echo "GitNotFound")
LDFLAGS= -X github.com/feifeigood/checkup/cmd.Version=$(VERSION)  -X 'github.com/feifeigood/checkup/cmd.GitSHA=$(GIT_SHA)'
...
build:
	@echo ">> build checkup"
	$(GO) build -v -o out/$(BINARY_NAME) -ldflags "$(LDFLAGS)" $(MAIN_PATH)
